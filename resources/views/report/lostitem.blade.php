<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if(request('user_id'))
                <div class="mb-4 p-4 bg-amber-50 border-l-4 border-amber-400 text-amber-700 flex justify-between items-center shadow-sm rounded-r-lg">
                    <div>
                        <span class="font-bold">Admin Mode:</span> Viewing items for a specific user.
                    </div>
                    <a href="{{ route('report.lostitem') }}" class="text-xs bg-amber-200 px-2 py-1 rounded hover:bg-amber-300 transition uppercase font-bold text-amber-800">
                        Show All Items
                    </a>
                </div>
            @endif
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                    ...
                    <a href="{{ route('report.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-black rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-blue-700 transition shadow-sm">
