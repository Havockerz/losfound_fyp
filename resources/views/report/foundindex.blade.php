<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            @if ($errors->any())
                            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb
                4">
                                <ul>
            ...
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                <form action="{{ route('report.foundstore') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <select name="item_type" id="item_type" class="block mt-1 w-full border
gray-300 rounded-md shadow-sm">
                        ...
                        <div>
                            <x-input-label for="reported_date" :value="__('Date Found')" />
...
full border-gray-300 rounded-md shadow-sm" placeholder="General description visible to 
everyone..." required></textarea>
                    </div>
