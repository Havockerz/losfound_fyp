<x-app-layout>
    ...
    <tr>
        ...
        <th class="px-6 py-3 text-center">Actions</th> </tr>
</thead>
<tbody>
    @forelse ($items as $item)
        <tr class="bg-white border-b hover:bg-gray-50 transition">
            <td class="px-6 py-4">
                ...
                @else
                    <div class="w-12 h-12 bg-gray-100 flex items-center justify-center rounded-lg text-[10px] text-gray-400">No Image</div>
                @endif
            </td>
            ...
            <td class="px-6 py-4">{{ \Carbon\Carbon::parse($item->reported_date)->format('d M Y') }}</td>
            <td class="px-6 py-4">
            ...
            <td class="px-6 py-4">
                <div class="flex items-center justify-center gap-3">
                    <a href="{{ route('report.foundview', $item->id) }}" 
