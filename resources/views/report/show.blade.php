            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        @if($item->image)
                            <img src="{{ asset('storage/' . $item->image) }}" class="w-full h-auto rounded-lg shadow-md border">
                        @else
                            <div class="w-full h-64 bg-gray-100 flex items-center justify-center rounded-lg border-2 border-dashed">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p>
                                <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $item->status === 'returned' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                                    {{ ucfirst($item->status) }}
                                </span>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-gray-900">{{ \Carbon\Carbon::parse($item->reported_date)->format('d F Y') }}</p>
                        </div>
                ...
                <div class="mt-8 flex justify-end">
                    <a href="javascript:history.back()" class="text-gray-600 hover:text-gray-900 font-medium transition">
                        &larr; Back to List
                    </a>
                </div>
