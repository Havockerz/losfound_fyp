    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                ...
                <form action="{{ route('items.claim.store', $item->id) }}" method="POST" enctype="multipart/form-data"
                    class="space-y-6">
                    @csrf
                    <div>
...
unique keychain..." required />
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="5" class="mt-1 block w-full border-gray-300 focus:border-blue-500 focus:ring-blue
500 rounded-md shadow-sm" placeholder="Please describe when and where you lost it, the contents (if it's a 
...
semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" />
                    ...
                    <div class="flex items-center justify-between pt-4 border-t">
                        <a href="javascript:history.back()" class="text-sm text-gray-600 hover:text-gray-900-transition">
                            Cancel
                        </a>
